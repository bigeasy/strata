    ...
    flow(function (callback) {
      if (! unambiguous) {
        ...
        flow(function (callback) {
          ...
          io.keychain(sibling = sibling_, 0, callback());
...
function createBalancer (leafSize) {
        ...
        flow(function (callback) {
          ...
          if (! node = ordered[address]) {
            flow(function (callback) {
              ...
              io.keychain(page = page_, 0, callback());
          ...
          if (node.length - length < 0 && node.page.address != -1 && ! node.left) {
            ...
            flow(function (callback) {
              ...
              io.keychain(descent.page, 0, check(done, callback));
            }, function (callback, key) {
              var left =
              { page: descent.page
  ...
  return objectify.call(this, create, open, iterator, _stats, close);
}
