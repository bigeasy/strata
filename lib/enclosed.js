...
function Descent (override) {
  ...
  return objectify.call(this, descend, fork, exclude, upgrade, key, leftMost, penultimate, leaf, _page, _index);
}
...
function Balancer () {
  ...
  objectify.call(methods, splitLeaf);
  ...
  function operate (callback) {
    ...
    function shift () {
      ...
      if (operation) {
        methods[operation.method](operation, check(shift));
      } else {
  ...
  function splitLeaf (context, callback) {
    ...
    // will be removed.
    penultimate.descend(penultimate.key(context.key), penultimate.penultimate, check(upgrade));
    ...
    function fork () {
      ...
      leaf.descend(leaf.key(context.key), leaf.leaf, check(dirty));
    }
    ...
    function cleanup() {
      ...
      // unlocked.
      shouldSplitBranch(penultimate.page, context.key, callback);
    }
  }
